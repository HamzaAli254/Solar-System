...
1.	Open the website  using the demo link or scan the QR code 
2.	Use the buttons of each section on the homepage below
3.	Use the buttons to go to the homepage, previous page, or next page
# Website Sections
1. Main Page
2. Sun
3. Inner planets
